...
function JobLayout() {
  const {jobs, jobPagination, handleGetAllJobs, selectedJobs, setSelectedJobs} = useJob();
  useEffect(() => {
    handleGetAllJobs();
  }, [])
  console.log(jobs);
...
>
  ...
  <main className="min-w-0 flex-1">
    ...
    {selectedJobs && (<JobDetails job={selectedJobs} onClose={() => setSelectedJobs(null)}/>)}
